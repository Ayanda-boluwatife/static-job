    ...
    return (
        <section className="static-jobs-filter-section">
            ...
            <li className="static-jobs-applied-filter">
                ...
                <button className='static-jobs-filter-remove-btn' onClick={() => removeFilter(category)}><img src={remove} alt="" className="static-jobs-filter-remove-icon"/></button>
            </li>
            ))}
            </ul>
            <button className="static-jobs-clear-filter-btn" onClick={()=>setCategories([])} >Clear all</button>
        </section>
    )
}
